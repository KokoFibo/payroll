            ...
            <div class="row">
                  ...
                  <div class="col-md-6">
                        <div class="mb-3 form-group">
                              ...
                              <input wire:model="tanggal_lahir" type="date" class="date form-control @error('tanggal_lahir') is-invalid @enderror">
                              @error('tanggal_lahir')
                              <div class="invalid-feedback">
                              ...
                              <div class="row">
                                    <div class="col-md-3">
                                          <div class="form-check">
                                                <input wire:model="gender" class="form-check-input" type="radio" value="Laki-laki" name="flexRadioDefault" id="flexRadioDefault1">
                                    ...
                                    <div class="col-md-3">
                                          <div class="form-check">
                                                <input wire:model="gender" class="form-check-input" type="radio" value="Perempuan" name="flexRadioDefault" id="flexRadioDefault2">
