                              ...
                              <table class="table  table-sm  table-hover mb-2">
                                    <thead>
                                          <tr>
                                                ...
                                                <th class="text-center" wire:click="sortColumnName('branch')">Branch <i class="fa-solid fa-sort"></i></th>
                                                <th class="text-center" wire:click="sortColumnName('departemen')">Departemen <i class="fa-solid fa-sort"></i>
                                                </th>
                                                <th class="text-center" wire:click="sortColumnName('jabatan')">Jabatan <i class="fa-solid fa-sort"></i></th>
                                                @if (Auth::user()->role > 2)
                                                <th class="text-center" wire:click="sortColumnName('level_jabatan')">Level Jabatan
                                                      <i class="fa-solid fa-sort"></i>
                                                      @endif
                                                </th>
                                                <th class="text-center" wire:click="sortColumnName('status_karyawan')">Status <i class="fa-solid fa-sort"></i>
                                                </th>
                                                ...
                                                <th class="text-center" wire:click="sortColumnName('gaji_pokok')">Gaji Pokok <i class="fa-solid fa-sort"></i>
                                                </th>
                                                <th class="text-center" wire:click="sortColumnName('gaji_overtime')">Overtime <i class="fa-solid fa-sort"></i>
                                                </th>
                                                <th class="text-center" wire:click="sortColumnName('bonus')">Bonus <i class="fa-solid fa-sort"></i>
                                                </th>
                                                @endif
                                          ...
                                          <tr>
                                                <td>
                                                      <div class="text-start">
                                                            <a href="/karyawanupdate/{{ $data->id }}"><button class="btn btn-success btn-sm"><i class="fa-regular fa-pen-to-square"></i></button></a>

                                                            @if (Auth::user()->role == 3 || Auth::user()->role == 4)
                                                            <button wire:click="confirmDelete(`{{ $data->id }}`)" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can"></i></button>
                                                            @endif
                                                      </div>
                                                </td>
