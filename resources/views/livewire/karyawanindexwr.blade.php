                    ...
                    <table class="table  table-sm  table-hover mb-2 ">
                        <thead>
                            <tr>
                                ...
                                @if (Auth::user()->role > 3)
                                    <th style="width: 150px; border-style: none;"><select
                                            wire:model.live="search_tanggal_bergabung" class="form-select"
                                            aria-label="Default select example">
                                    ...
                                    <th style="width: 150px; border-style: none;"><select
                                            wire:model.live="search_gaji_pokok" class="form-select"
                                            aria-label="Default select example">
                                    ...
                                    <th style="width: 150px; border-style: none;"><select
                                            wire:model.live="search_gaji_overtime" class="form-select"
                                            aria-label="Default select example">
