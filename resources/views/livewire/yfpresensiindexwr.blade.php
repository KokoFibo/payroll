<div>
                              ...
                              <table class="table table-sm table-hover mb-4">
                                    <thead>
                                          <tr>
                                                ...
                                                <td wire:click="sortColumnName('overtime_out')">Overtime out <i class="fa-solid fa-sort"></i>
                                                </td>
                                    ...
                                    <tbody>
                                          ...
                                          <tr x-data="{ edit: false }" class="{{ $data->no_scan ? 'table-warning' : '' }}">
                                                <td>
                                                      ...
                                                      @if ($btnEdit == true)
                                                      <button @click="edit = !edit" wire:click="update({{ $data->id }})" class="btn btn-success btn-sm"><i class="fa-regular fa-pen-to-square"></i></button>
                                                      @else
                                                      @if ($data->id == $selectedId)
                                                      <button @click="edit = !edit" wire:click="save" class="btn btn-primary btn-sm"><i class="fa-solid fa-floppy-disk"></i></button>
                                                      @else
                                                      <button @click="edit = !edit" disabled wire:click="save" class="btn btn-success btn-sm"><i class="fa-regular fa-pen-to-square"></i></button>
                                                      @endif
                                                      @endif
                                                      ...
                                                      @if (Auth::user()->role > 3)
                                                      <button wire:click="$dispatch('swal:confirm', { id: {{ $data->id }} })" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash-can confirm-delete"></i></button>
                                                      @endif
                                                </td>
                                                <td>{{ $data->user_id }}</td>
                                                ...
                                                <td x-show="!edit" class="{{ checkFirstInLate($data->first_in, $data->shift, $data->date) ? 'text-danger' : '' }}">
                                                      {{ format_jam($data->first_in) }} </td>
                                                <td x-show="edit"><input style="width:100px; background-color: #ffeeba;; background-color: #ffeeba" class="form-control @error('first_in') is-invalid @enderror" id="first_in" type="text" wire:model="first_in">
                                                      @error('first_in')
                                                ...
                                                <td x-show="!edit" class="{{ checkFirstOutLate($data->first_out, $data->shift, $data->date) ? 'text-danger' : '' }}">
                                                      {{ format_jam($data->first_out) }} </td>
                                                <td x-show="edit"><input style="width:100px; background-color: #ffeeba;" class="form-control @error('first_out') is-invalid @enderror" id="first_out" type="text" wire:model="first_out">
                                                      @error('first_out')
                                                      <div class="invalid-feedback">
                                                            Format jam harus sesuai HH:MM
                                                      </div>
                                                ...
                                                <td x-show="!edit" class="{{ checkSecondInLate($data->second_in, $data->shift, $data->first_out, $data->date) ? 'text-danger' : '' }}">
                                                      {{ format_jam($data->second_in) }} </td>
                                                <td x-show="edit"><input style="width:100px; background-color: #ffeeba;" class="form-control @error('second_in') is-invalid @enderror" id="second_in" type="text" wire:model="second_in">
                                                      @error('second_in')
                                                      <div class="invalid-feedback">
                                                            Format jam harus sesuai HH:MM
                                                      </div>
                                                ...
                                                <td x-show="!edit" class="{{ checkSecondOutLate($data->second_out, $data->shift, $data->date) ? 'text-danger' : '' }}">
                                                      {{ format_jam($data->second_out) }} </td>
                                                <td x-show="edit"><input style="width:100px; background-color: #ffeeba;" class="form-control @error('second_out') is-invalid @enderror" id="second_out" type="text" wire:model="second_out">
                                                      @error('second_out')
                                                      <div class="invalid-feedback">
                                                            Format jam harus sesuai HH:MM
                                                      </div>
                                                ...
                                                <td x-show="!edit" class="{{ checkOvertimeInLate($data->overtime_in, $data->shift, $data->date) ? 'text-danger' : '' }}">
                                                      {{ format_jam($data->overtime_in) }} </td>
                                                <td x-show="edit"><input style="width:100px; background-color: #ffeeba;" class="form-control @error('overtime_in') is-invalid @enderror" id="overtime_in" type="text" wire:model="overtime_in">
                                                      @error('overtime_in')
                                                      <div class="invalid-feedback">
                                                            Format jam harus sesuai HH:MM
                                                      </div>
                                                ...
                                                <td x-show="edit"><input style="width:100px; background-color: #ffeeba;" class="form-control @error('overtime_out') is-invalid @enderror" id="overtime_out" type="text" wire:model="overtime_out">
                                                      @error('overtime_out')
                                                      <div class="invalid-feedback">
                                                            Format jam harus sesuai HH:MM
                                                      </div>
      ...
      {{-- Modal --}}
      <div wire:ignore.self class="modal fade" id="update-form-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                  <div class="modal-content">
                              ...
                              <div class="row">
                                    ...
                                    <div class="mb-3 col-6">
                                          <label for="first_in" class="form-label">First
                                                In</label>
                                          <input class="form-control @error('first_in') is-invalid @enderror" id="first_in" type="text" wire:model="first_in">
                                          @error('first_in')
                                          <div class="invalid-feedback">
                                                Format jam harus sesuai HH:MM
                                          </div>
                                    ...
                                    <div class="mb-3 col-6">
                                          <label for="first_out" class="form-label">First
                                                Out</label>
                                          <input class="form-control @error('first_out') is-invalid @enderror" id="first_out" type="text" wire:model="first_out">
                                          @error('first_out')
                                          <div class="invalid-feedback">
                                                Format jam harus sesuai HH:MM
                                          </div>
                              ...
                              <div class="row">
                                    ...
                                    <div class="mb-3 col-6">
                                          <label for="second_in" class="form-label">Second
                                                In</label>
                                          <input class="form-control @error('second_in') is-invalid @enderror" id="second_in" type="text" wire:model="second_in">
                                          @error('second_in')
                                          <div class="invalid-feedback">
                                                Format jam harus sesuai HH:MM
                                          </div>
                                    ...
                                    <div class="mb-3 col-6">
                                          <label for="second_out" class="form-label">Second
                                                Out</label>
                                          <input class="form-control @error('second_out') is-invalid @enderror" id="second_out" type="text" wire:model="second_out">
                                          @error('second_out')
                                          <div class="invalid-feedback">
                                                Format jam harus sesuai HH:MM
                                          </div>
                              ...
                              <div class="row">
                                    ...
                                    <div class="mb-3 col-6">
                                          <label for="overtime_in" class="form-label">Overtime
                                                In</label>
                                          <input class="form-control @error('overtime_in') is-invalid @enderror" id="overtime_in" type="text" wire:model="overtime_in">
                                          @error('overtime_in')
                                          <div class="invalid-feedback">
                                                Format jam harus sesuai HH:MM
                                          </div>
                                    ...
                                    <div class="mb-3 col-6">
                                          <label for="overtime_out" class="form-label">Overtime
                                                Out</label>
                                          <input class="form-control @error('overtime_out') is-invalid @enderror" id="overtime_out" type="text" wire:model="overtime_out">
                                          @error('overtime_out')
                                          <div class="invalid-feedback">
                                                Format jam harus sesuai HH:MM
                                          </div>
                        ...
                        <div class="modal-footer">
                              ...
                              @if ($datas->isNotEmpty())
                              <button wire:click="save({{ $data->id }})" type="button" class="btn btn-primary">Update</button>
                              @endif
