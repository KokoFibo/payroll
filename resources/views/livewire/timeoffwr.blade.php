                                                    ...
                                                    <div class="lg:my-5 py-2 w-full lg:w-1/2 ">
                                                        <div class="d-flex justify-content-between px-1 pb-2">
                                                            <div>
                                                                ...
                                                                <p
                                                                    class="text-sm py-1 lg:text-xl font-medium lg:font-bold">
                                                                    {{ $fn->originalName }}
                                                                </p>
                                                            </div>
                                ...
                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                    <div class="mb-4">
                                        <label for="requester_name"
                                            ...
                                            Pemohon</label>
                                        <input id="requester_name" name="requester_name" type="text"
                                            wire:model='name' disabled
                                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    </div>
                                    <div class="mb-4">
                                        <label for="request_type"
                                            class="block text-gray-700 text-sm font-bold mb-2">Tipe
                                            Izin/Cuti</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="start_date"
                                            class="block text-gray-700 text-sm font-bold mb-2">Tanggal Mulai</label>
