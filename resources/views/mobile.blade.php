...
<body style="font-family: 'nunito';">
    ...
    <div class=header>
        <div class="w-screen bg-black h-32 shadow-xl rounded-b-3xl flex justify-between sticky top-0 ">
            <div>
        ...
        <div class="flex px-3 -mt-3 justify-center ">
    ...
    <div class="footer flex justify-between h-15 fixed bottom-0 left-0 right-0 ">
        @if (isset($data))
            ...
            <a href="{{ $data->previousPageUrl() }}"><button
                    class="bg-white text-purple-500 px-4 py-3 rounded shadow-xl"><i class="fa-solid fa-left-long"></i>
                </button></a>

            {{-- @endif --}}
            <button class="bg-white text-purple-500 px-4 py-3 rounded shadow-xl"><i
                    class="fa-solid fa-file-invoice"></i>
            </button>
            <button class="bg-white text-purple-500 px-4 py-3 rounded shadow-xl"><i class="fa-solid fa-house"></i>
            </button>
            <button class="bg-white text-purple-500 px-4 py-3 rounded shadow-xl"><i class="fa-solid fa-circle-info"></i>
            </button>
            {{-- @if ($data->hasMorePages()) --}}
            <a href="{{ $data->nextPageUrl() }}"><button
                    class="bg-white text-purple-500 px-4 py-3 rounded shadow-xl"><i
