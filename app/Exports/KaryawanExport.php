...
class KaryawanExport implements FromCollection, FromQuery, WithHeadings, ShouldAutoSize
{
    ...
    public function collection()
    {
        ...
        return Karyawan::whereIn('id', $this->selectedAll)->get(['id_karyawan', 'nama', 'email', 'hp', 'telepon', 'tempat_lahir', 'tanggal_lahir', 'gender', 'status_pernikahan', 'golongan_darah', 'agama', 'jenis_identitas', 'no_identitas', 'alamat_identitas', 'alamat_tinggal', 'status_karyawan', 'tanggal_bergabung', 'company', 'departemen', 'jabatan', 'level_jabatan', 'metode_penggajian', 'gaji_pokok', 'gaji_overtime', 'bonus', 'tunjangan_jabatan', 'tunjangan_bahasa', 'tunjangan_skill', 'tunjangan_lembur_sabtu', 'tunjangan_lama_kerja', 'iuran_air', 'potongan_seragam', 'denda']);
    }
    public function headings(): array
    {
        return ['Id', 'Nama', 'Email', 'Handphone', 'Telepon', 'Tempat Lahir', 'Tanggal Lahir', 'Gender', 'Status Pernikahan', 'Golongan Darah', 'Agama', 'Jenis Identitas', 'No Identitas', 'Alamat Identitas', 'Alamat Tinggal', 'Status Karyawan', 'Tanggal Bergabung', 'Company', 'Department', 'Jabatan', 'Level Jabatan', 'Metode Penggajian', 'Gaji Pokok', 'Gaji Overtime', 'Bonus', 'Tunjangan Jabatan', 'Tunjangan Bahasa', 'Tunjangan Skill', 'tunjangan Lembur Sabtu', 'Tunjangan Lama Kerja', 'Iuran Air', 'Potongan Seragam', 'Denda'];
    }
