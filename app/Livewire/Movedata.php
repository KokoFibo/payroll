...
class Movedata extends Component
{
    ...
    public function search()
    {
        ...
        $apiUrlKaryawan =  "https://salary.accel365.id/api/getkaryawan/" . $this->id_karyawan;
        $apiUrlUser =  "https://salary.accel365.id/api/getuser/" . $this->id_karyawan;
    ...
    public function move()
    {
        ...
        $apiUrlDeleteKaryawan =  "https://salary.accel365.id/api/delete_karyawan_yf_aja/" . $this->id_karyawan;
        $apiUrlDeleteUser =  "https://salary.accel365.id/api/delete_user_yf_aja/" . $this->id_karyawan;
